...
#se cargan los datos en formato csv ingles (existen problemas con las tildes y las ñ)
datos <- read.csv("C:\\Users\\digna\\Documents\\Usach\\IME\\Actividad 1 (formativa)\\tabla_datos.csv", encoding = "UTF-8")
